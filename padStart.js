...
//  The string "Lydia Hallie" has a length of 12. name.padStart(13) inserts 1 space at the start of
//  the string, because 12 + 1 is 13.

// If the argument passed to the padStart method is smaller than the length of the array,
